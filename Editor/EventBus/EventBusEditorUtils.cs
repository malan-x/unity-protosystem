...
{{
    ...
    {{
        ...
        {{
            // ═══════════════════════════════════════════════════════════════════
            // ДОБАВЛЯЙТЕ НОВЫЕ СОБЫТИЯ СЮДА (в алфавитном порядке по категориям)
            // ═══════════════════════════════════════════════════════════════════

            // === ПРИМЕР КАТЕГОРИИ ===
            // МояКатегория_Событие_1,
            // МояКатегория_Событие_2,

            // Добавляйте новые события в конец списка
        }}
        ...
        // {{
        //     public const int Событие_1 = (int)EventType.МояКатегория_Событие_1;
        //     public const int Событие_2 = (int)EventType.МояКатегория_Событие_2;
        // }}
