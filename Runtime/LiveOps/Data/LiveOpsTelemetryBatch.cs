...
namespace ProtoSystem.LiveOps
{
    ...
    public class LiveOpsTelemetryBatch
    {
        ...
        /// <summary>
        /// Заезды проводит бот, а не человек (<c>LiveOpsSystem.BotMode</c>).
        /// Сервер выносит такие сессии в отдельный срез project_id (суффикс
        /// ".bot"): статистика ботов не смешивается с живыми игроками ни в
        /// метриках баланса, ни в DAU/онлайне.
        /// </summary>
        public bool bot;
